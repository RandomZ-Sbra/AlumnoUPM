...
public class Reserva implements Comparable<Reserva> {
  ...
  private String dniPasaporte; // dni o pasaporte del cliente haciendo la reserva
  ...
  /**
   * Devuelve el numero del documento de indentidad del cliente realisando la
   * reserva
   * 
   ...
   * @param dniPasaporte el documento de indentidad del cliente realisando la
   *                     reserva
  ...
  public boolean equals(Object obj) {
    ...
    if (obj instanceof Reserva) {
      ...
      return this.getHabitacion().equals(otherReserva.getHabitacion())
  ...
  public String toString() {
    return "Reserva(\"" + getHabitacion() + "\"," + getDniPasaporte() + ",\"" + getDiaEntrada() + "\",\""
        + getDiaSalida() + "\")";
  }
}
